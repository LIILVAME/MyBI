  ...
  <div class="flex min-h-screen bg-gray-50">
    ...
    <main class="flex-1 overflow-y-auto">
      <div class="max-w-7xl mx-auto px-3 pt-16 pb-20 sm:px-6 lg:px-8 sm:pt-10 sm:pb-10">
        ...
        <!-- Erreur -->
        <div v-else-if="propertiesStore.error" class="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
        ...
        const handleUpdateProperty = async (updatedData) => {
          ...
          try {
            await propertiesStore.updateProperty(selectedProperty.value.id, {
              ...
              tenant: updatedData.status === PROPERTY_STATUS.OCCUPIED && updatedData.tenant
                ? {
